...
pub use self::heap::max as max_heapify;
pub use self::heap::build_max as build_max_heap;
pub use self::heap::min as min_heapify;
pub use self::heap::build_min as build_min_heap;
